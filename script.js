...
//Score Show
function show_score() {
    let max_score_first = localStorage.getItem('first') || 0;
    let max_score_second = localStorage.getItem('second') || 0;
    localStorage.setItem('first', 0);
    localStorage.setItem('second', 0);

    if (max_score_first > max_score_second) {
        window.alert("Player 1 is the winner with a maximum score of " + max_score_first.toString() + "\n" + "Player 2 scored " + max_score_second.toString());
    } else if (max_score_first < max_score_second) {
        window.alert("Player 2 is the winner with a maximum score of " + max_score_second.toString() + "\n" + "Player 1 scored " + max_score_first.toString());
    } else {
        window.alert("It's a tie! Both players scored " + max_score_first.toString());
    }
}
